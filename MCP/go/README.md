...
This MCP (Model Content Protocol) server provides access to AWS Resource Groups Tagging API API functionality through HTTP, HTTPS, and STDIO transport modes.
