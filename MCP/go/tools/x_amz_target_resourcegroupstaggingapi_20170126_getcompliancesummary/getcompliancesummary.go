...
func GetcompliancesummaryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetComplianceSummaryInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=ResourceGroupsTaggingAPI_20170126.GetComplianceSummary%s", cfg.BaseURL, queryString)
		...
		var result models.GetComplianceSummaryOutput
...
func CreateGetcompliancesummaryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=ResourceGroupsTaggingAPI_20170126_GetComplianceSummary",
		...
		mcp.WithString("RegionFilters", mcp.Description("")),
		mcp.WithString("ResourceTypeFilters", mcp.Description("")),
		mcp.WithString("TagKeyFilters", mcp.Description("")),
		mcp.WithString("TargetIdFilters", mcp.Description("")),
		mcp.WithString("GroupBy", mcp.Description("")),
		mcp.WithString("MaxResults", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetcompliancesummaryHandler(cfg),
	}
}
