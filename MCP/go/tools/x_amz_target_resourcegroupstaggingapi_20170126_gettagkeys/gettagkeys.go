...
func GettagkeysHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetTagKeysInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=ResourceGroupsTaggingAPI_20170126.GetTagKeys%s", cfg.BaseURL, queryString)
		...
		var result models.GetTagKeysOutput
...
func CreateGettagkeysTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=ResourceGroupsTaggingAPI_20170126_GetTagKeys",
