...
func GettagvaluesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetTagValuesInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=ResourceGroupsTaggingAPI_20170126.GetTagValues%s", cfg.BaseURL, queryString)
		...
		var result models.GetTagValuesOutput
...
func CreateGettagvaluesTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    GettagvaluesHandler(cfg),
	}
}
