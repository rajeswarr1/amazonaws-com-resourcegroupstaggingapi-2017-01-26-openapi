...
func UntagresourcesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UntagResourcesInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=ResourceGroupsTaggingAPI_20170126.UntagResources", cfg.BaseURL)
		...
		var result models.UntagResourcesOutput
...
func CreateUntagresourcesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=ResourceGroupsTaggingAPI_20170126_UntagResources",
	...
	return models.Tool{
		Definition: tool,
		Handler:    UntagresourcesHandler(cfg),
	}
}
